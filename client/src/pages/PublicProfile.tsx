            ...
            <div className="space-y-4">
              ...
              {(user.contact_info?.phone || 
                ...
                <div className="border-t border-gray-200 pt-4">
                  ...
                  >
                    <h2 className="text-sm font-semibold text-gray-700">Contact & Social Media</h2>
                    <svg 
                      className={`w-5 h-5 text-gray-500 transition-transform duration-200 ${showContactInfo ? 'rotate-180' : ''}`}
                      fill="none" 
                      viewBox="0 0 24 24" 
                      stroke="currentColor"
                    >
                  ...
                  {showContactInfo && (
                    <div className="mt-4 space-y-4 animate-in slide-in-from-top-2 duration-200">
                      ...
                      {(user.contact_info?.phone || user.contact_info?.address) && (
                        <div>
                          <h3 className="text-xs font-medium text-gray-500 uppercase mb-2">Contact Information</h3>
                      ...
                      {(user.contact_info?.social_media?.linkedin || 
                        ...
                        user.contact_info?.social_media?.instagram) && (
                        <div>
                          <h3 className="text-xs font-medium text-gray-500 uppercase mb-2">Social Media</h3>
